            ...
            file : [
                {
                    ...
                    title: 'ALL-PARTIES.COM | ВЕЧЕРИНКИ',
                    desc: '22.04.2018 22:00 Вечеринка на коттедже в ратомке',
                    button: {
                        text: 'Присоединиться',
                        url: 'https://vk.com/steel.muscles',
                ...
                },
                {
                    ...
                    title: 'ALL-PARTIES.COM | ВЕЧЕРИНКИ',
                    desc: '24.04.2018 22:00 Пенная вечеринка на Минском море с тремя очаровательными малышками',
                    button: {
                        text: 'Присоединиться',
                        url: 'https://vk.com/steel.muscles',
                        class: 'btn btn-medium btn-primary',
                ...
                },
                {
                    ...
                    title: 'ALL-PARTIES.COM | ВЕЧЕРИНКИ',
                    desc: '24.03.2018 22:00 Лейла уже джёт тебя на яхте',
                    button: {
                        text: 'Присоединиться',
                        url: 'https://vk.com/steel.muscles',
                        class: 'btn btn-medium btn-primary',
                ...
                },
                {
                    ...
                    title: 'ALL-PARTIES.COM | ВЕЧЕРИНКИ',
                    desc: '24.03.2018 22:00 Клавдия желает покататься на своей бричке с молодым человеком',
                    button: {
                        text: 'Присоединиться',
                        url: false,
                        class: 'btn btn-medium btn-primary',
